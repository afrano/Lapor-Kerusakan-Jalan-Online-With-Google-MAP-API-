                ...
                <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                    <nav class="menu menu--juliet">
                        <ul class="nav navbar-nav">
                            <li class="menu__item menu__item--current"><a href="index.php?koor" class="menu__link">Daftar Laporan Perbaikan</a></li>
                          </ul>
        ...
        <div class="banner-bottom  " style="height: 200px;margin-left: 10%;margin-right:10% ">
            <div class="grid_3 grid_5 ">
                ...
                <ol class="breadcrumb well" style="margin: 0px; ">
                    <li class="active"><a href="index.php?koor"><- Kembali</a></li>
                ...
                <div  class="grid_5" style="margin-left: 1%; margin-right: 1% ; background-color: #fff">
                    <div class='input-group input-group-lg w3_w3layouts' style='padding-left: 10%;padding-right: 10%'>
                        ...
                        <div class='input-group input-group-lg w3_w3layouts' style='padding-left: 10%;padding-right: 10%'>
                         ...
                         <div class='input-group input-group-lg w3_w3layouts' style='padding-left: 10%;padding-right: 10%'>
                            <span class='input-group-addon' id='sizing-addon1' >Luas Kerusakan</span>
                            <input type="text" name="kerusakan" value="" id="kerusakan" class='form-control' aria-describedby='sizing-addon1' >                    
                        </div> 

                    </div>
                    <div  class="grid_5" style="margin-left: 1%; margin-right: 1%;height: 1000px ; background-color: #fff" >
                        <div class="well" style="text-align: center; background-color: #ccffff;margin-left: 5%;margin-right: 5%;">Lokasi dan Foto Jalan</div>
                                ...
                                <center>
                                    <table style="width: 60% ; background-color: #fff">
                                        <tr>
                                            ...
                                            <td><button class="btn-success" type="submit" name="selesai" value="selesai" style="width: 100%;height: 100px; background-color: #00ff66;font-size: 25px">Selesai</button></td>
                                            <td><button class="btn-warning" type="submit"  name="batal" value="batal" style="width: 100%;height: 100px;font-size: 25px">Batal</button></td>
                                        </tr>
                                    </table>
                                </center> 
                            </div>
...
?>
            ...
            <?php
            if (isset($_POST['selesai'])) { //jika button submit diklik maka panggil fungsi update pada controller
                $main = new LaporanDAO();
                $main->Selesai();
            } else if (isset ($_POST['batal'])){
                echo "<script>alert('Pending Pengerjaan !!');"
